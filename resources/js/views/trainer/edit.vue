                    ...
                    <v-container>
                        <v-row>
                            ...
                            <v-form
                                ...
                                <label for="" align="left">Edit Trainer</label>
    ...
    methods:{
        ...
        go(){
         ...
         .then((ress) => {
             ...
             this.select = user.id_category
             this.kelamin = user.kelamin
             this.imgurl = user.foto_profile ? user.foto_profile : this.imgurl
